...
class WC_WJ_Abandoned_Cart_Integration {
    ...
    public function add_admin_menu() {
        add_submenu_page( 'woocommerce', 'ReCart', 'ReCart Settings', 'manage_options', 'recart-settings', array( $this->admin, 'render' ) );
    }
    ...
    public function add_plugin_row_meta( $links, $file ) {
        if ( plugin_basename( RECART_PLUGIN_FILE ) === $file ) {
            $new_links = array(
                ...
                'store'   => '<a href="https://webbyjack.com/store" target="_blank" style="color:#e05d22; font-weight:bold;">' . esc_html__( 'Explore ReCart Pro', 'recart' ) . '</a>',
            );
